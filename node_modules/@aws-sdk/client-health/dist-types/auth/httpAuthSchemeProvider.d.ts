 ...
 * @internal
 */
export interface HealthHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<HealthClientResolvedConfig, HandlerExecutionContext, HealthHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultHealthHttpAuthSchemeParametersProvider: (config: HealthClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<HealthHttpAuthSchemeParameters>;
/**
 * @internal
 */
